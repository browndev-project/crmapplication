...
class VisitCreateDialog extends ConsumerStatefulWidget {
  ...
  const VisitCreateDialog({super.key, required this.leadId});
...
class _VisitCreateDialogState extends ConsumerState<VisitCreateDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await ref.read(visitsProvider.notifier).createVisit(payload);

      if (mounted) {
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Site visit created successfully'), backgroundColor: Colors.green),
        );
      }
    } catch (e) {
      if (mounted) {
             ...
             child: Column(
               ...
               children: [
                 ...
                 Row(
                   ...
                   children: [
                     Text("Create Visit", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyLarge?.color)),
                     InkWell(
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTextField("Description", _descriptionController, isDark, maxLines: 4, enableVoiceToText: true),
                        const SizedBox(height: 16),
