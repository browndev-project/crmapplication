...
class PropertyShareDialog extends ConsumerStatefulWidget {
  final Property property;

  const PropertyShareDialog({super.key, required this.property});

  @override
  ConsumerState<PropertyShareDialog> createState() => _PropertyShareDialogState();
}

class _PropertyShareDialogState extends ConsumerState<PropertyShareDialog> {
