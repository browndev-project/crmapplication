...
class MatchPropertyDetailsScreen extends StatefulWidget {
  ...
  const MatchPropertyDetailsScreen({
    super.key,
  ...
  @override
  State<MatchPropertyDetailsScreen> createState() => _MatchPropertyDetailsScreenState();
}

class _MatchPropertyDetailsScreenState extends State<MatchPropertyDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          _buildOverviewTab(isDark, p),
          _buildStatsTab(isDark, p),
          _buildMediaTab(isDark, p),
        ],
      ),
    );
  }
  ...
  Widget _buildStatsTab(bool isDark, Property p) {
  ...
  Widget _buildMediaTab(bool isDark, Property p) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
